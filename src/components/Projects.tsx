...
const projectCategories = {
  ...
  "uiux": [
    ...
    {
      title: "FreshSip Fruit Juice App",
      description: "Complete multi-page design system for fruit juice e-commerce app featuring About page, Orange and Strawberry product screens with vibrant color schemes and intuitive navigation flow",
      media: fruitJuiceOverview,
      type: "image",
      tags: ["Figma", "App Design", "Multi-Screen Flow"],
    },
    {
